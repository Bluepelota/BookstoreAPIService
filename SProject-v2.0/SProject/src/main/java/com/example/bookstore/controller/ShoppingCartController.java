...
public class ShoppingCartController {
    ...
    @PostMapping("/add")
    public ResponseEntity<CartItem> addBookToCart(@RequestParam Long userId, @RequestParam Long bookId) {
        CartItem cartItem = cartService.addBookToCart(userId, bookId);
